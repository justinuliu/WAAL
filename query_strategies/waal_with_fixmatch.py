    ...
    def train(self, alpha, total_epoch):
        ...
        for epoch in range(n_epoch):
            ...
            for index, (label_x, _), label_y, (unlabel_x_w, unlabel_x_s), _ in loader_tr:
                ...
                wassertein_distance = self.dis(unlb_z_w).mean() - gamma_ratio * self.dis(lb_z).mean()
                ...
                gp = gradient_penalty(self.dis, unlb_z_w, lb_z)
                ...
                loss = pred_loss + alpha * wassertein_distance + alpha * gp * 5 + Lu
